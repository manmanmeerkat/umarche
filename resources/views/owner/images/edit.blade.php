                ...
                <div class="p-6 text-gray-900">
                    ...
                    <form id="delete_{{$image->id}}" method="post" action="{{ route('owner.images.destroy', ['image' => $image->id ] )}}">
                        ...
                        <div class="p-2 mt-32 w-full flex justify-around">
                         <a href="#" data-id="{{ $image->id }}" onclick="deletePost(this)" class="text-white bg-red-400 border-0 py-2 px-4 focus:outline-none hover:bg-red-500 rounded text-lg">削除する</button>
                     </div>
                    </form>
                </div>
            </div>
